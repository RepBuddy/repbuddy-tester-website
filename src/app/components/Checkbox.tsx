...
export default function Checkbox({ id, label, span, checked, setChecked, url }: { id: string; label: string; span?: string; checked: boolean; setChecked: (checked: boolean) => void; url?: string }) {
